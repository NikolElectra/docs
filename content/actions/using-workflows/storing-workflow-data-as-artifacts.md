...
**Note:** Artifacts can be generated by any workflow, including those that run from forks during pull requests. Remember to validate the source of artifacts before executing code with them.
{% endnote %}
